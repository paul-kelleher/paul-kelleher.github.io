...
My book [***The Social Cost of Carbon: Ethics and the Limits of Climate Change Economics***](https://global.oup.com/academic/product/the-social-cost-of-carbon-9780197687796?lang=en&cc=us) was published by Oxford University Press in March 2025.

Click [here](https://github.com/paul-kelleher/paul-kelleher.github.io/blob/main/files/Kelleher_SCCbook_Preface_preprint.pdf?raw=true) to download a preprint version of the stage-setting Preface. Click [here](https://github.com/paul-kelleher/paul-kelleher.github.io/blob/main/sccbook/Book%20overview.pdf?raw=true) to download a document that contains abstracts of each chapter.
:::
:::
...
::: {.column width="40%"}
![](images/cover_from_proof_w_OUP-01.jpg){width="186" style="margin-top: 0;"}
:::
::::::
